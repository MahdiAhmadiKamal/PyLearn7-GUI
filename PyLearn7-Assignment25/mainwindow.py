...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(610, 521)
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName(u"centralwidget")
        self.tabWidget = QTabWidget(self.centralwidget)
        self.tabWidget.setObjectName(u"tabWidget")
        self.tabWidget.setGeometry(QRect(30, 10, 551, 461))
        ...
        self.btn_germany_worldclock.setGeometry(QRect(220, 230, 91, 31))
        font = QFont()
        font.setPointSize(12)
        self.btn_germany_worldclock.setFont(font)
        self.btn_usa_worldclock = QPushButton(self.tab)
        self.btn_usa_worldclock.setObjectName(u"btn_usa_worldclock")
        self.btn_usa_worldclock.setGeometry(QRect(320, 230, 91, 31))
        self.btn_usa_worldclock.setFont(font)
        self.btn_iran_worldclock = QPushButton(self.tab)
        self.btn_iran_worldclock.setObjectName(u"btn_iran_worldclock")
        self.btn_iran_worldclock.setGeometry(QRect(120, 230, 91, 31))
        self.btn_iran_worldclock.setFont(font)
        ...
        self.lbl_worldclock.setFont(font1)
        ...
        self.btn_add_alarm.setGeometry(QRect(200, 400, 141, 31))
        ...
        self.tbx_new_alarm_name.setGeometry(QRect(150, 350, 241, 31))
        font2 = QFont()
        font2.setPointSize(14)
        font2.setBold(False)
        self.tbx_new_alarm_name.setFont(font2)
        self.bx_time = QTimeEdit(self.tab_2)
        self.bx_time.setObjectName(u"bx_time")
        self.bx_time.setGeometry(QRect(150, 250, 241, 61))
        font3 = QFont()
        font3.setFamilies([u"Seven Segment"])
        font3.setPointSize(25)
        self.bx_time.setFont(font3)
        self.bx_time.setCurrentSection(QDateTimeEdit.HourSection)
        self.layoutWidget = QWidget(self.tab_2)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(20, 20, 511, 221))
        ...
        self.label.setGeometry(QRect(150, 320, 91, 31))
        ...
        self.lbl_stopwatch.setGeometry(QRect(150, 90, 231, 71))
        ...
        self.btn_start_stopwatch.setGeometry(QRect(120, 230, 91, 31))
        ...
        self.btn_stop_stopwatch.setGeometry(QRect(220, 230, 91, 31))
        ...
        self.btn_reset_stopwatch.setGeometry(QRect(320, 230, 91, 31))
        ...
        self.tbx_hour_timer.setGeometry(QRect(110, 110, 90, 90))
        font4 = QFont()
        font4.setFamilies([u"Seven Segment"])
        font4.setPointSize(50)
        self.tbx_hour_timer.setFont(font4)
        ...
        self.tbx_minute_timer.setGeometry(QRect(220, 110, 90, 90))
        self.tbx_minute_timer.setFont(font4)
        ...
        self.tbx_second_timer.setGeometry(QRect(330, 110, 90, 90))
        self.tbx_second_timer.setFont(font4)
        ...
        self.btn_reset_timer.setGeometry(QRect(320, 230, 91, 31))
        ...
        self.btn_stop_timer.setGeometry(QRect(220, 230, 91, 31))
        ...
        self.btn_start_timer.setGeometry(QRect(120, 230, 91, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bx_time.setDisplayFormat(QCoreApplication.translate("MainWindow", u"hh:mm:ss AP", None))
        self.label.setText(QCoreApplication.translate("MainWindow", u"Alarm Name:", None))
